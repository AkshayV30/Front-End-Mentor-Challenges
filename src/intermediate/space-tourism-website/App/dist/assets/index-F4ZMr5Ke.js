(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(e){e.innerHTML=`
  ...
  `;let r=e.querySelector(`.js-tech-nav`),i=e.querySelector(`.js-tech-image`),a=e.querySelector(`.js-tech-name`),o=e.querySelector(`.js-tech-desc`);function s(e){i.classList.add(`is-hidden`),a.classList.add(`is-hidden`),o.classList.add(`is-hidden`),requestAnimationFrame(()=>{i.src=e.images.portrait,i.alt=e.name,a.textContent=e.name,o.textContent=e.description,i.classList.remove(`is-hidden`),a.classList.remove(`is-hidden`),o.classList.remove(`is-hidden`)})}s(n[0]),r.addEventListener(`click`,e=>{let t=e.target.closest(`.js-tech-btn`);t&&(r.querySelectorAll(`.js-tech-btn`).forEach(e=>e.classList.remove(`is-active`)),t.classList.add(`is-active`),s(n[t.dataset.index]))})}var a={crews:[{name:`Douglas Hurley`,images:{png:`/src/assets/images/crews/douglas-hurley.png`,webp:`/src/assets/images/crews/douglas-hurley.webp`},role:`Commander`,bio:`Douglas Gerald Hurley is an American engineer, former Marine Corps pilot and former NASA astronaut. He launched into space for the third time as commander of Crew Dragon Demo-2.`},{name:`Mark Shuttleworth`,images:{png:`/src/assets/images/crews/mark-shuttleworth.png`,webp:`/src/assets/images/crews/mark-shuttleworth.webp`},role:`Mission Specialist`,bio:`Mark Richard Shuttleworth is the founder and CEO of Canonical, the company behind the Linux-based Ubuntu operating system. Shuttleworth became the first South African to travel to space as a space tourist.`},{name:`Victor Glover`,images:{png:`/src/assets/images/crews/victor-glover.png`,webp:`/src/assets/images/crews/victor-glover.webp`},role:`Pilot`,bio:`Pilot on the first operational flight of the SpaceX Crew Dragon to the International Space Station. Glover is a commander in the U.S. Navy where he pilots an F/A-18.He was a crew member of Expedition 64, and served as a station systems flight engineer.`},{name:`Anousheh Ansari`,images:{png:`/src/assets/images/crews/anousheh-ansari.png`,webp:`/src/assets/images/crews/anousheh-ansari.webp`},role:`Flight Engineer`,bio:`Anousheh Ansari is an Iranian American engineer and co-founder of Prodea Systems. Ansari was the fourth self-funded space tourist, the first self-funded woman to fly to the ISS, and the first Iranian in space.`}],destinations:[{name:`Moon`,images:{png:`/src/assets/images/destinations/moon.png`,webp:`/src/assets/images/destinations/moon.webp`},description:`See our planet as you’ve never seen it before. A perfect relaxing trip away to help regain perspective and come back refreshed. While you’re there, take in some history by visiting the Luna 2 and Apollo 11 landing sites.`,distance:`384,400 km`,travel:`3 days`},{name:`Mars`,images:{png:`/src/assets/images/destinations/mars.png`,webp:`/src/assets/images/destinations/mars.webp`},description:`Don’t forget to pack your hiking boots. You’ll need them to tackle Olympus Mons, the tallest planetary mountain in our solar system. It’s two and a half times the size of Everest!`,distance:`225 mil. km`,travel:`9 months`},{name:`Europa`,images:{png:`/src/assets/images/destinations/europa.png`,webp:`/src/assets/images/destinations/europa.webp`},description:`The smallest of the four Galilean moons orbiting Jupiter, Europa is a winter lover’s dream. With an icy surface, it’s perfect for a bit of ice skating, curling, hockey, or simple relaxation in your snug wintery cabin.`,distance:`628 mil. km`,travel:`3 years`},{name:`Titan`,images:{png:`/src/assets/images/destinations/titan.png`,webp:`/src/assets/images/destinations/titan.webp`},description:`The only moon known to have a dense atmosphere other than Earth, Titan is a home away from home (just a few hundred degrees colder!). As a bonus, you get striking views of the Rings of Saturn.`,distance:`1.6 bil. km`,travel:`7 years`}],technologies:[{name:`Launch vehicle`,images:{portrait:`/src/assets/images/technologys/launch-vehicle-portrait.jpg`,landscape:`/src/assets/images/technologys/launch-vehicle-landscape.jpg`},description:`A launch vehicle or carrier rocket is a rocket-propelled vehicle used to carry a payload from Earth's surface to space, usually to Earth orbit or beyond. Our WEB-X carrier rocket is the most powerful in operation. Standing 150 metres tall, it's quite an awe-inspiring sight on the launch pad!`},{name:`Spaceport`,images:{portrait:`/src/assets/images/technologys/spaceport-portrait.jpg`,landscape:`/src/assets/images/technologys/spaceport-landscape.jpg`},description:`A spaceport or cosmodrome is a site for launching (or receiving) spacecraft, by analogy to the seaport for ships or airport for aircraft. Based in the famous Cape Canaveral, our spaceport is ideally situated to take advantage of the Earth’s rotation for launch.`},{name:`Space capsule`,images:{portrait:`/src/assets/images/technologys/space-capsule-portrait.jpg`,landscape:`/src/assets/images/technologys/space-capsule-landscape.jpg`},description:`A space capsule is an often-crewed spacecraft that uses a blunt-body reentry capsule to reenter the Earth's atmosphere without wings. Our capsule is where you'll spend your time during the flight. It includes a space gym, cinema, and plenty of other activities to keep you entertained.`}]},o={home:{render:e},crew:{render:n,data:{inlineData:a.crews,key:`crews`,storeKey:`crews`}},destination:{render:r,data:{inlineData:a.destinations,key:`destinations`,storeKey:`destinations`}},technology:{render:i,data:{inlineData:a.technologies,key:`technologies`,storeKey:`technologies`}}};function s(e){let t=document.body;[...t.classList].filter(e=>e.startsWith(`page-`)).forEach(e=>t.classList.remove(e)),t.classList.add(`page-${e}`)}var c=document.getElementById(`app`);async function l(e){if(!e.data)return;let{path:n,key:r,storeKey:i,inlineData:a}=e.data;t.data[i]?.length||(c.innerHTML=`<div class="u-loading"></div>`,t.data[i]=a)}async function u(e){let n=o[e];n&&(c.innerHTML=``,t.currentPage=e,m(e),s(e),await l(n),n.render(c))}var d=`data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20width='48'%20height='48'%3e%3cg%20fill='none'%20fill-rule='evenodd'%3e%3ccircle%20cx='24'%20cy='24'%20r='24'%20fill='%23FFF'/%3e%3cpath%20fill='%230B0D17'%20d='M24%200c0%2016-8%2024-24%2024%2015.718.114%2023.718%208.114%2024%2024%200-16%208-24%2024-24-16%200-24-8-24-24z'/%3e%3c/g%3e%3c/svg%3e`,f=[{page:`home`,label:`Home`},{page:`destination`,label:`Destination`},{page:`crew`,label:`Crew`},{page:`technology`,label:`Technology`}];function p(){let e=document.querySelector(`.c-header`);e.innerHTML=`
